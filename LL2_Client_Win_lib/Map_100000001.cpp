...
void stb::Map_100000001::LoadMapResources()
{
    m_background = M_RESOURCEMANAGER->Find<Texture>(L"Forest_ground_2");
    m_BGM = M_RESOURCEMANAGER->Find<AudioClip>(L"BGM_Forest_ground_2");
}

void stb::Map_100000001::CreateColliders()
{
}

void stb::Map_100000001::OnMapEnter()
{
    if (m_BGM)
        m_BGM->Play();
...
void stb::Map_100000001::OnMapExit()
{
    if (m_BGM)
        m_BGM->Stop();
}

void stb::Map_100000001::RenderBackground(stbD2DRenderer& renderer)
{
